...
import { Play, GraduationCap, ClipboardList, BarChart3, Users } from "lucide-react";
...
export const metadata: Metadata = {
  ...
  description:
    "Explore the Edu Manage Pro webapp â€” an education management platform to run schools and learning institutions efficiently.",
};
...
const FEATURES = [
  ...
  },
  {
    ...
    description:
      "Designed for schools and learning centers â€” simple to adopt, easy to scale.",
  },
];
          ...
          <div className="grid grid-cols-1 gap-8 lg:grid-cols-2">
            <div className="space-y-6">
              ...
              <div className="flex flex-col gap-3 sm:flex-row">
                ...
                <OrderModal projectTitle="Edu Manage Pro" />
              </div>
            </div>
...
{FEATURES.map((feature, i) => (
              ...
              <OrderModal projectTitle="Edu Manage Pro" variant="link" />
            </div>
          </div>
        </Container>
      </section>
