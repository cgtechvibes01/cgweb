              ...
              const card = (
                <GlassCard key={project.title} className="group flex h-full flex-col">
                  ...
                  <div className="flex items-center justify-between">
                    {!project.image && (
                      <div className="bg-gradient-orange grid h-12 w-12 place-items-center rounded-xl text-white shadow-lg shadow-primary/25 transition-transform duration-300 group-hover:scale-110">
                        {project.icon ? (
